...
import com.dji.sdk.sample.demo.wpmission.WpmissionView;
...
public class DemoListView extends FrameLayout {
    ...
    private void initView(Context context) {
        ...
        builder.addGroup(R.string.component_listview_navigation,
                false,
                new GroupItem(R.string.component_listview_wpmission, WpmissionView.class)
                );
