...
public class WaypointMissionOperatorView extends MissionBaseView {
    ...
    private static final double VERTICAL_DISTANCE = 50;

    private WaypointMissionOperator waypointMissionOperator = null;
    private FlightController flightController = null;
    private WaypointMission mission = null;
    private WaypointMissionOperatorListener listener;
    private static final int WAYPOINT_COUNT = 2;
    private FlightMode mysetFlightMode = FlightMode.GPS_WAYPOINT;
    ...
    /*
    public void setFlightMode(FlightMode mysetFlightMode) {
        this.mysetFlightMode = mysetFlightMode;
    }

    public FlightMode getFlightMode() {
        return mygetFlightMode ;
    }*/
    public FlightMode getMyFlightMode() {
        FlightControllerState flightstate = new FlightControllerState();
        FlightMode mysetFlightMode = flightstate.getFlightMode();
        return mysetFlightMode;
    }

    public void setMyFlightMode() {
        FlightControllerState flightstate = new FlightControllerState();
        flightstate.setFlightMode(mysetFlightMode);
    }
    ...
    public void onClick(View view) {
        ...
        switch(view.getId()) {
            ...
            case R.id.btn_set_maximum_radius:
                MissionControl.getInstance().destroy();
                //setMyFlightMode();
                if (null != getFlightController()) {
            ...
            case R.id.btn_load:
                ...
                int PointListCount = mission.getWaypointCount();
                String listcount = "" + PointListCount;
                DJIError djiError = getWaypointMissionOperator().loadMission(mission);
                ...
                if (djiError == null) {
                    ...
                    //Toast.makeText(getContext().getApplicationContext(), PointListCount, Toast.LENGTH_SHORT).show();
                    String errortext = "" + djiError.getErrorCode();
                    ToastUtils.setResultToToast(djiError.getDescription());
                }
                break;
    ...
    private WaypointMission createRectangleWaypointMission() {
        ...
        double baseLatitude = 22.0;
        double baseLongitude = 113.0;
        ...
        waypoint0.addAction(new WaypointAction(WaypointActionType.STAY, 0));
        ...
        waypoint1.addAction(new WaypointAction(WaypointActionType.STAY, 0));
